...
def dadisnp_parser(passed_arguments):
    ...
    dadisnp_parser.add_argument('--model', help = 'Defines the model and the individual(s)/population(s) to include', required = True,type = str)
...
##                 '--comment','testing comment'] #'--outgroup-fasta',"chr22_hg18.fa",'--bed-file',"twochr_test.bed",]
##    debugargs = ['--vcf',"Pan_all_hicov_chr22_decrun_missingasref.vcf.gz",'--model-file',"panmodels.model",
##                 '--model',"4Pop",'--out','dadisnp_test.out',

...
import vcf_filter, vcf_calc, vcf_sampler

#Work for results, data_dir for storage
work_dir = '/home/jared/workspace/projects_ppp/python_pipelines/stickleback/'
...
main_vcf_name = data_dir+'BEAGLE.Combined66.snpEff1Effect.SNPs.OnlyInCombined66.masked68.nocnvrs.recode.vcf'
...
vcf_calc.run(['--vcf',filtered_vcf_pref+'.recode.vcf.gz','--out-prefix',stat_file_pref,'--calc-statistic','windowed-weir-fst','--model','2Pop','--statistic-window-size','10000','--statistic-window-step','20000','--model-file',work_dir+'sticklebackmodel.txt','--overwrite'])

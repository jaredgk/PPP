...
class vcftools_tests (unittest.TestCase):
    ...
    def test_produce_vcftools_log (self):
        ...
        self.assertTrue(compare_to_expected('out.logTest.log', 'andrew' + '/' + 'example/locus8.logTest.log'))
    ...
    def test_calculate_Fst (self):
        ...
        self.assertTrue(compare_to_expected('out.windowed.weir.fst', 'andrew' + '/' + 'example/locus8.windowed.weir.fst'))
    ...
    def test_calculate_pi (self): 
        vcf_scripts.calculate_pi(['--gzvcf', 'andrew' + '/' + 'example/locus8.vcf.gz', '--out', 'out'])

...
class vcftools_tests (unittest.TestCase):
    ...
    def test_Fst (self):
        vcf_scripts.vcftools_wrapper(['--gzvcf', 'example/locus8.vcf.gz', '--weir-fst-pop', 'example/Paniscus.txt', '--weir-fst-pop', 'example/Troglodytes.txt', '--out', 'out'])
    ...
    def test_Fst_window (self):
        vcf_scripts.vcftools_wrapper(['--gzvcf', 'example/locus8.vcf.gz', '--weir-fst-pop', 'example/Paniscus.txt', '--weir-fst-pop', 'example/Troglodytes.txt', '--out', 'out', '--fst-window-size', '--fst-window-step'])
    ...
    def test_tajimasD (self): 
        vcf_scripts.vcftools_wrapper(['--gzvcf', 'example/locus8.vcf.gz', '--out', 'out', '--TajimaD'])
    ...
    def test_window_pi (self): 
        vcf_scripts.vcftools_wrapper(['--gzvcf', 'example/locus8.vcf.gz', '--out', 'out', '--window-pi'])
    ...
    def test_freq (self):    
        vcf_scripts.vcftools_wrapper(['--gzvcf', 'example/locus8.vcf.gz', '--out', 'out', '--freq'])
    ...
    def test_het (self):    
        vcf_scripts.vcftools_wrapper(['--gzvcf', 'example/locus8.vcf.gz', '--out', 'out', '--het'])
